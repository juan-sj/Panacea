                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content all-icons">
                                ...
                                <a href="../consultation/select.php">    <div class="font-icon-detail"><i class="pe-7s-user"></i>
...
include("../connection.php");
 $result = mysqli_query($con,"SELECT * FROM patient WHERE patient_regno='$_POST[aadhar]'");
