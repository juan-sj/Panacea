...
if($i==1)
{
	...
	echo "<td><input type='hidden' name='$name'> </td>";
	...
	<div class='col-md-4'>
		<div class='form-group'>
			<label>
		  	...
		  	<input type='text' name='$name' value='ktmpt' class='form-control' > 
	  	</div>
    </div>";
}


elseif($name=="patient_gender")
{
	echo "
	<div class='col-md-4'>
		<div class='form-group'>
...
";
//<div class='col-md-3'>   <div class='form-group'><form action='select.php' method='post'><input type='submit' name='view' value='View All' class='form-control btn-danger'></form></div></div>
